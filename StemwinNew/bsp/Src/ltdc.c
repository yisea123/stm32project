...
//根据不同的颜色格式,定义帧缓存数组
u16 ltdc_lcd_framebuf1[1024][600] __attribute__ ((section (".mb5ltdc")));	//((section (".hbss")));
u16 ltdc_lcd_framebuf2[1024][600] __attribute__ ((section (".mb5ltdc")));	//((section (".hbss")));
...
{   
	...
	ltdc_framebuf[1]=(u32*)&ltdc_lcd_framebuf2;
#endif 	
    if(lcdid==0X7084)
    {
