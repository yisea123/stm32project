/*
 * object dictionary for slave3 - generated by CANopen DeviceDesigner 2.4.4.6
 * Fr. Juni 17 12:46:02 2016
 */
#include <stdlib.h>
...
static CO_CONST VIS_STRING CO_CONST_STORAGE_CLASS	od_const_vis_string[2] = {
	"Test_String",
	"Test Slave 3 with block transfer"};
...
CO_CONST CO_OBJECT_DESC_T od_description[CO_OBJ_DESC_CNT] CO_CONST_STORAGE_CLASS = {
	...
	{ (UNSIGNED8)0u, CO_DTYPE_VS_PTR   , (UNSIGNED16)0u, CO_ATTR_READ | CO_ATTR_WRITE | CO_ATTR_DEFVAL,  (UNSIGNED16)0u},/* 0x3001:0*/ 
...
CO_CONST CO_OD_ASSIGN_T od_assign[CO_OD_ASSIGN_CNT] CO_CONST_STORAGE_CLASS = {
	...
	{ 0x1600u, 2u, 1u, CO_ODTYPE_STRUCT, 15u },
	{ 0x1800u, 6u, 5u, CO_ODTYPE_STRUCT, 17u },
	{ 0x1a00u, 2u, 1u, CO_ODTYPE_STRUCT, 23u },
	{ 0x2001u, 1u, 0u, CO_ODTYPE_VAR, 25u },
	{ 0x3000u, 1u, 0u, CO_ODTYPE_VAR, 26u },
	{ 0x3001u, 1u, 0u, CO_ODTYPE_VAR, 27u },
	{ 0x3002u, 1u, 0u, CO_ODTYPE_VAR, 28u },
};
    ...
    )
{
    ...
    /* initialize TPDO 1 */
    retVal = coPdoTransmitInit(1u, od_const_u8[3], od_const_u16[1], od_const_u16[1], 0u, NULL);
    if (retVal != RET_OK) {
        return(retVal);
    }
    /* initialize RPDO 1 */
