/*
 * Stack definitions for slave1 - generated by CANopen DeviceDesigner 2.4.4.6
...
#define CO_OBJECTS_LINE_0_CNT	12u
#define CO_OBJECT_COUNTS	12u
...
#define CO_NODE_IDS	0u
#define CO_NODE_ID_FUNCTIONS	getNodeId
...
extern unsigned char getNodeId();
