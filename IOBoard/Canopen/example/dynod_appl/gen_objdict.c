...
/* number of objects */
#define CO_OD_ASSIGN_CNT 10u
#define CO_OBJ_DESC_CNT 30u
...
static CO_CONST UNSIGNED16 CO_CONST_STORAGE_CLASS	od_const_u16[3] = {
	...
	(UNSIGNED16)0u,
	(UNSIGNED16)3000u};
static CO_CONST UNSIGNED32 CO_CONST_STORAGE_CLASS	od_const_u32[3] = {
	(UNSIGNED32)0UL,
	(UNSIGNED32)793UL,
	(UNSIGNED32)512UL};
...
CO_CONST CO_OBJECT_DESC_T od_description[CO_OBJ_DESC_CNT] CO_CONST_STORAGE_CLASS = {
	...
	{ (UNSIGNED8)1u, CO_DTYPE_U32_RPDO , (UNSIGNED16)1u, CO_ATTR_NUM | CO_ATTR_READ | CO_ATTR_WRITE | CO_ATTR_DEFVAL,  (UNSIGNED16)2u},/* 0x1400:1*/ 
    ...
    )
{
    ...
    /* initialize RPDO 1 */
    retVal = coPdoReceiveInit(1u, od_const_u8[4], od_const_u16[1], od_const_u16[2], NULL);
    if (retVal != RET_OK) {
        return(retVal);
    }
