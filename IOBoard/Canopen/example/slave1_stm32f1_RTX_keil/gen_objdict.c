/*
 * object dictionary for slave1 - generated by CANopen DeviceDesigner 2.2.1
 * Mo 13. Jul 16:18:02 2015
 */
#include <stdlib.h>
...
CO_CONST CO_OD_ASSIGN_T od_assign[CO_OD_ASSIGN_CNT] CO_CONST_STORAGE_CLASS = {
	...
	{ 0x2001u, 1u, 0u, CO_ODTYPE_VAR, 38u },
	{ 0x3000u, 3u, 2u, CO_ODTYPE_ARRAY, 39u },
};

/* static PDO mapping tables */
/* Mapping table RPDO 1*/
    ...
    )
{
    ...
    /* initialize RPDO 1 */
    retVal = coPdoReceiveInit(1u, od_const_u8[5], od_const_u16[0], od_const_u16[2], &mapTableRPDO1);
    if (retVal != RET_OK) {
        return(retVal);
    }
