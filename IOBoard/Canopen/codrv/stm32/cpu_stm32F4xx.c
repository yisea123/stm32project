...
*-------------------------------------------------------------------
* $Id: cpu_stm32F4xx.c 18371 2017-05-30 11:04:24Z hil $
*
*
*-------------------------------------------------------------------
*
...
#if CO_TIMER_INTERVAL != 1000
# error "Adapt codrvTimerSetup() to the different timer interval!!"
#endif
	...
	)
{
	...
	/*
	 * Using the HAL tick
	 * Initialization is done in HAL_InitTick()
	 */
