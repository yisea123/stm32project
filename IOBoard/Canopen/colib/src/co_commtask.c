...
*-------------------------------------------------------------------
* $Id: co_commtask.c 18612 2017-06-15 10:38:28Z boe $
*
*
*-------------------------------------------------------------------
*
...
# endif /* CO_SDO_NETWORKING */
		...
		case CO_SERVICE_USDO_SERVER: 
			...
			break;
# ifdef CO_USDO_CLIENT_SUPPORTED
		case CO_SERVICE_USDO_CLIENT:
			icoUsdoClientHandler(&recData);
			break;
# endif /* CO_USDO_CLIENT_SUPPORTED */
#endif /* CO_USDO_SUPPORTED */
