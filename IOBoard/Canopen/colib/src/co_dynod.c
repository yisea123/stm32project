...
RET_T retVal;
	...
	switch (pDesc->dType)  {
	case CO_DTYPE_U8_PTR:
		dynData.pU8[pDesc->tableIdx] = (UNSIGNED8 *) pVar; /*lint !e960 Note: pointer arithmetic other than array indexing used */
		break;
	case CO_DTYPE_U16_PTR:
		dynData.pU16[pDesc->tableIdx] = (UNSIGNED16 *) pVar; /*lint !e960 Note: pointer arithmetic other than array indexing used */
		break;
	case CO_DTYPE_U32_PTR:
		dynData.pU32[pDesc->tableIdx] = (UNSIGNED32 *) pVar; /*lint !e960 Note: pointer arithmetic other than array indexing used */
		break;
	case CO_DTYPE_I8_PTR:
		dynData.pI8[pDesc->tableIdx] = (INTEGER8 *) pVar; /*lint !e960 Note: pointer arithmetic other than array indexing used */
		break;
	case CO_DTYPE_I16_PTR:
		dynData.pI16[pDesc->tableIdx] = (INTEGER16 *) pVar; /*lint !e960 Note: pointer arithmetic other than array indexing used */
		break;
	case CO_DTYPE_I32_PTR:
		dynData.pI32[pDesc->tableIdx] = (INTEGER32 *) pVar; /*lint !e960 Note: pointer arithmetic other than array indexing used */
		break;
	default:
		return(RET_DATA_TYPE_MISMATCH);
		break;
