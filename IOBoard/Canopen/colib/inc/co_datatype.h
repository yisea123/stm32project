...
*
*-------------------------------------------------------------------
* $Id: co_datatype.h 18606 2017-06-15 10:29:19Z boe $
*-------------------------------------------------------------------
*
*
*
...
#ifndef CO_DEBUG
# define CO_DEBUG		shell_Add
# define CO_DEBUG1		shell_Add
# define CO_DEBUG2		shell_Add
# define CO_DEBUG3		shell_Add
# define CO_DEBUG4		shell_Add
#endif /* CO_DEBUG */
/*lint -restore */
