...
#define VALID_RST_MSG  0x87654321u
#define DUMP_SIZE		4000
extern uint32_t validPrintMsg;
extern uint32_t validPrintLen;
extern uint8_t  printfbuffDump[DUMP_SIZE];
// ----------------------------------------------------------------------------
...
extern "C"
{
  ...
  ssize_t
  trace_write(const char* buf, size_t nbyte, int chn);
...
extern "C"
{
  ...
  // Implementation dependent
  inline ssize_t
  trace_write(const char* buf, size_t nbyte,0);
