...
*-------------------------------------------------------------------
* $Id: co_cobhandler.c 19918 2017-09-26 13:15:23Z boe $
*
*
*-------------------------------------------------------------------
*
...
static void icoCobSortList(CO_COB_T *pCob);
...
#ifdef CO_COB_SORTED_LIST
static COB_REFERENZ_T	cobSortCnt = { 0u };
...
COB_REFERENZ_T	cobRef;
	...
	cobData[cobRef].cobNr = (COB_REFERENZ_T)(cobRef + 1u);
