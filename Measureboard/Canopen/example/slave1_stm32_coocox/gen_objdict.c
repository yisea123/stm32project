...
static CO_CONST VIS_STRING CO_CONST_STORAGE_CLASS	od_const_vis_string[1] = {
	"Check if segmented(normal) transfer is supported"};
...
CO_CONST CO_OD_ASSIGN_T od_assign[CO_OD_ASSIGN_CNT] CO_CONST_STORAGE_CLASS = {
	...
	{ 0x1600u, 3u, 2u, CO_ODTYPE_STRUCT, 27u },
	{ 0x1800u, 6u, 5u, CO_ODTYPE_STRUCT, 30u },
	{ 0x1a00u, 3u, 2u, CO_ODTYPE_STRUCT, 36u },
