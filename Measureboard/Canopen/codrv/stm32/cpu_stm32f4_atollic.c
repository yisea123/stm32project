/*
* cpu_stm32f4_atollic.c
*
* Copyright (c) 2012-2017 emtas GmbH
*-------------------------------------------------------------------
* $Id: cpu_stm32f4_atollic.c 18866 2017-06-27 10:15:25Z hil $
*
*
*-------------------------------------------------------------------
*
...
/**
* \file
* \brief CPU driver for Cortex-M4 from STM32 (e.g. STM32F4xx)
*
...
#error please define wich CAN Line you want to use
#endif
...
CO_CONST CODRV_BTR_T codrvCanBittimingTable[] = {
		/* 42MHz table */
		{  125u,  21u, 0u, 13u, 2u }, /* 87.5% */
		{  250u,  12u, 0u, 11u, 2u }, /* 85.7% */
		{  500u,   6u, 0u, 11u, 1u }, /* 85.7% */
		{ 1000u,   3u, 0u, 11u, 1u }, /* 85.7% */
		{0u, 0u, 0u, 0u, 0u} /* last */
	};
