...
extern __IO float		fluidVolume_Remain[VOL_MAX_ID];
extern __IO uint32_t 	lifeSpan_InstalledSeconds[LIFESPAN_W_MAX_ID];
extern __IO uint32_t	lifeSpanTubing_StaticSeconds[LIFESPAN_W_TUBING_MAX];
...
extern __IO PowerOnOff powerOnOff_ST;
extern __IO STA_LifeTime lifeTime_STA;
...
extern __IO uint32_t communicationStatus[COM_MAX_COUNT];
extern __IO uint32_t communicationHappenST[COM_MAX_COUNT];
