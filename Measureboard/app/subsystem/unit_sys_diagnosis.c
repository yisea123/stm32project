...
uint16_t AdcVolts[ST_ADC_MAX_CHN];
uint8_t	_diagnosisLoc[DIAG_MAX_ID] = {0,0,};
uint8_t		diagnosisOutput[DIAG_MAX_ID] = {0,0,};
uint8_t diag_IO[2];
uint16_t powerSupply[2];//0 is voltage; 1: is current
int16_t leakageVolt;
int16_t humidity;
int16_t rtcVolt;
...
{
		DIA_ENABLE|	DIA_MASK|	DIA_NONE|	DIA_NONE|	DIA_AUTO_CLR|	DIA_NONE|	DIA_REMINDER	,//	0	MEAS_OUT_OF_RANGE,
		DIA_ENABLE|	DIA_NONE|	DIA_NONE|	DIA_NONE|	DIA_AUTO_CLR|	DIA_NONE|	DIA_REMINDER	,//	1	LOCAL_COMMUNICATION_ERR,
		DIA_ENABLE|	DIA_NONE|	DIA_RELAY_EVENT|	DIA_AO_EXCEPTION|	DIA_NONE|	DIA_NONE|	DIA_WARNING	,//	2	LED_OUTPUT_LOW,
		DIA_ENABLE|	DIA_MASK|	DIA_RELAY_EVENT|	DIA_AO_EXCEPTION|	DIA_AUTO_CLR|	DIA_NONE|	DIA_WARNING	,//	3	NO_SAMPLE_FLOW,
		DIA_ENABLE|	DIA_NONE|	DIA_RELAY_EVENT|	DIA_AO_EXCEPTION|	DIA_AUTO_CLR|	DIA_NONE|	DIA_WARNING	,//	4	HEAT_OUT_CTRL,
		DIA_ENABLE|	DIA_NONE|	DIA_RELAY_EVENT|	DIA_AO_EXCEPTION|	DIA_AUTO_CLR|	DIA_NONE|	DIA_WARNING	,//	5	DOOR_OPEN,
		DIA_ENABLE|	DIA_NONE|	DIA_RELAY_EVENT|	DIA_AO_EXCEPTION|	DIA_AUTO_CLR|	DIA_NONE|	DIA_WARNING	,//	6	AD_SPI_FAILURE,
		DIA_ENABLE|	DIA_NONE|	DIA_RELAY_EVENT|	DIA_AO_EXCEPTION|	DIA_NONE|	DIA_NONE|	DIA_WARNING	,//	7	FLASH_FAILURE,
		DIA_ENABLE|	DIA_NONE|	DIA_RELAY_EVENT|	DIA_AO_EXCEPTION|	DIA_AUTO_CLR|	DIA_NONE|	DIA_WARNING	,//	8	EEPROM_ERROR,
		DIA_ENABLE|	DIA_NONE|	DIA_NONE|	DIA_NONE|	DIA_NONE|	DIA_NONE|	DIA_NONE	,//	9	RAM_FAILURE,
		DIA_ENABLE|	DIA_MASK|	DIA_NONE|	DIA_NONE|	DIA_AUTO_CLR|	DIA_NONE|	DIA_REMINDER	,//	10	POWER_FAILUR,
		DIA_ENABLE|	DIA_NONE|	DIA_RELAY_EVENT|	DIA_AO_EXCEPTION|	DIA_AUTO_CLR|	DIA_NONE|	DIA_REMINDER	,//	11	VOLT_OUT_RANGE,
		DIA_ENABLE|	DIA_NONE|	DIA_RELAY_EVENT|	DIA_AO_EXCEPTION|	DIA_NONE|	DIA_NONE|	DIA_WARNING	,//	12	TEMP_SENSOR_FAILURE,
		DIA_ENABLE|	DIA_MASK|	DIA_RELAY_EVENT|	DIA_AO_EXCEPTION|	DIA_AUTO_CLR|	DIA_NONE|	DIA_WARNING	,//	13	CASE_TEMP_WARNING,
		DIA_ENABLE|	DIA_NONE|	DIA_RELAY_EVENT|	DIA_AO_EXCEPTION|	DIA_AUTO_CLR|	DIA_NONE|	DIA_WARNING	,//	14	FAILED_CALIBRATION,
		DIA_ENABLE|	DIA_NONE|	DIA_RELAY_EVENT|	DIA_AO_EXCEPTION|	DIA_NONE|	DIA_STOPACTION|	DIA_ERROR	,//	15	LEAKAGE_WARNING,
		DIA_ENABLE|	DIA_NONE|	DIA_RELAY_EVENT|	DIA_AO_EXCEPTION|	DIA_AUTO_CLR|	DIA_NONE|	DIA_WARNING	,//	16	CHECK_OPTICS,
		DIA_ENABLE|	DIA_NONE|	DIA_NONE|	DIA_NONE|	DIA_NONE|	DIA_NONE|	DIA_REMINDER	,//	17	REAGENT_INVALID,
		DIA_ENABLE|	DIA_MASK|	DIA_RELAY_EVENT|	DIA_AO_EXCEPTION|	DIA_AUTO_CLR|	DIA_NONE|	DIA_WARNING	,//	18	CURRENT_ERROR,
		DIA_ENABLE|	DIA_MASK|	DIA_RELAY_EVENT|	DIA_AO_EXCEPTION|	DIA_AUTO_CLR|	DIA_NONE|	DIA_WARNING	,//	19	ALARM_LOW,
		DIA_ENABLE|	DIA_MASK|	DIA_RELAY_EVENT|	DIA_AO_EXCEPTION|	DIA_AUTO_CLR|	DIA_NONE|	DIA_WARNING	,//	20	ALARM_HIGH,
		DIA_ENABLE|	DIA_MASK|	DIA_NONE|	DIA_NONE|	DIA_AUTO_CLR|	DIA_NONE|	DIA_REMINDER	,//	21	REAGNET_EMPTY_A ,
		DIA_ENABLE|	DIA_MASK|	DIA_NONE|	DIA_NONE|	DIA_AUTO_CLR|	DIA_NONE|	DIA_REMINDER	,//	22	REAGNET_EMPTY_B,
		DIA_ENABLE|	DIA_MASK|	DIA_NONE|	DIA_NONE|	DIA_AUTO_CLR|	DIA_NONE|	DIA_REMINDER	,//	23	REAGNET_EMPTY_C,
		DIA_ENABLE|	DIA_MASK|	DIA_NONE|	DIA_NONE|	DIA_AUTO_CLR|	DIA_NONE|	DIA_REMINDER	,//	24	STD_EMPTY_0,
		DIA_ENABLE|	DIA_MASK|	DIA_NONE|	DIA_NONE|	DIA_AUTO_CLR|	DIA_NONE|	DIA_REMINDER	,//	25	STD_EMPTY_1,
		DIA_ENABLE|	DIA_MASK|	DIA_NONE|	DIA_NONE|	DIA_AUTO_CLR|	DIA_NONE|	DIA_REMINDER	,//	26	STD_EMPTY_2,
		DIA_ENABLE|	DIA_MASK|	DIA_NONE|	DIA_NONE|	DIA_AUTO_CLR|	DIA_NONE|	DIA_REMINDER	,//	27	CLEANING_EMPTY,
		DIA_ENABLE|	DIA_MASK|	DIA_NONE|	DIA_NONE|	DIA_AUTO_CLR|	DIA_NONE|	DIA_REMINDER	,//	28	REAGNET_LOW_A,
		DIA_ENABLE|	DIA_MASK|	DIA_NONE|	DIA_NONE|	DIA_AUTO_CLR|	DIA_NONE|	DIA_REMINDER	,//	29	REAGNET_LOW_B,
		DIA_ENABLE|	DIA_MASK|	DIA_NONE|	DIA_NONE|	DIA_AUTO_CLR|	DIA_NONE|	DIA_REMINDER	,//	30	REAGNET_LOW_C,
		DIA_ENABLE|	DIA_MASK|	DIA_NONE|	DIA_NONE|	DIA_AUTO_CLR|	DIA_NONE|	DIA_REMINDER	,//	31	STD_LOW_0,
		DIA_ENABLE|	DIA_MASK|	DIA_NONE|	DIA_NONE|	DIA_AUTO_CLR|	DIA_NONE|	DIA_REMINDER	,//	32	STD_LOW_1,
		DIA_ENABLE|	DIA_MASK|	DIA_NONE|	DIA_NONE|	DIA_AUTO_CLR|	DIA_NONE|	DIA_REMINDER	,//	33	STD_LOW_2,
		DIA_ENABLE|	DIA_MASK|	DIA_NONE|	DIA_NONE|	DIA_AUTO_CLR|	DIA_NONE|	DIA_REMINDER	,//	34	CLEANING_LOW,
		DIA_ENABLE|	DIA_MASK|	DIA_NONE|	DIA_NONE|	DIA_AUTO_CLR|	DIA_NONE|	DIA_REMINDER	,//	35	LIFESPAN_TUBING_VALVE,
		DIA_ENABLE|	DIA_MASK|	DIA_NONE|	DIA_NONE|	DIA_AUTO_CLR|	DIA_NONE|	DIA_REMINDER	,//	36	LIFESPAN_TUBING_PUMP,
		DIA_ENABLE|	DIA_MASK|	DIA_NONE|	DIA_NONE|	DIA_AUTO_CLR|	DIA_NONE|	DIA_REMINDER	,//	37	LIFESPAN_MOTOR_PUMP1,
		DIA_ENABLE|	DIA_MASK|	DIA_NONE|	DIA_NONE|	DIA_AUTO_CLR|	DIA_NONE|	DIA_REMINDER	,//	38	LIFESPAN_MOTOR_PUMP2,
		DIA_ENABLE|	DIA_MASK|	DIA_NONE|	DIA_NONE|	DIA_AUTO_CLR|	DIA_NONE|	DIA_REMINDER	,//	39	LIFESPAN_MOTOR_PUMP3,
		DIA_ENABLE|	DIA_MASK|	DIA_NONE|	DIA_NONE|	DIA_AUTO_CLR|	DIA_NONE|	DIA_REMINDER	,//	40	LIFESPAN_MOTOR_MIX,
		DIA_ENABLE|	DIA_MASK|	DIA_NONE|	DIA_NONE|	DIA_AUTO_CLR|	DIA_NONE|	DIA_REMINDER	,//	41	RTC_ALARM,
		DIA_ENABLE|	DIA_NONE|	DIA_RELAY_EVENT|	DIA_AO_EXCEPTION|	DIA_NONE|	DIA_STOPACTION|	DIA_ERROR	,//	42	LED_ERROR,
		DIA_ENABLE|	DIA_MASK|	DIA_NONE|	DIA_NONE|	DIA_AUTO_CLR|	DIA_NONE|	DIA_REMINDER	,//	43	CANOPEN_WARNING,
		DIA_ENABLE|	DIA_MASK|	DIA_NONE|	DIA_NONE|	DIA_AUTO_CLR|	DIA_NONE|	DIA_ERROR	,//	44	CANOPEN_ERROR,
		DIA_ENABLE|	DIA_MASK|	DIA_NONE|	DIA_NONE|	DIA_AUTO_CLR|	DIA_NONE|	DIA_WARNING	,//	45	CANOPEN_ER_CONNECT,
		DIA_ENABLE|	DIA_MASK|	DIA_NONE|	DIA_NONE|	DIA_AUTO_CLR|	DIA_NONE|	DIA_WARNING	,//	46	CANOPEN_ER_CONFIG,
		DIA_ENABLE|	DIA_MASK|	DIA_NONE|	DIA_NONE|	DIA_AUTO_CLR|	DIA_NONE|	DIA_REMINDER	,//	47	FIX_RANGE_WARNING,
};
...
static const T_DATA_OBJ _ObjList[] =
{
	...
	CONSTRUCT_ARRAY_SIMPLE_U16(
								&powerSupply[0],
								sizeof(powerSupply)/sizeof(uint16_t),
								READONLY_RAM),
...
void Dia_SetDiagnosis(uint16_t id, uint16_t val)
{
	...
	uint8_t msk = diaBehavior[id] & DIA_STOPACTION;
...
void RefreshDiagnosisOutput(void)
{
	...
	for(uint16_t id = 0; id<DIAG_MAX_ID;id++)
	{
		...
		if(msk)
		{
			if(diagnosisOutput[id] != _diagnosisLoc[id])
			{
				...
				if(id == LED_OUTPUT_LOW)
				{
					evData[1] = (uint8_t)ledDiagnosis;
					evData[2] = (uint8_t)(ledDiagnosis>>8);
				}
				else
				{
	...
	if(relayEvent_Bak != relayEvent)
	{
		...
		//	DO_Event_Trig = FATAL_ERROR;
			SendTskMsg(SCH_IO_ID, TSK_INIT, RO_EVENT_SET, NULL);
		}
		else
		{
		//	DO_Event_Trig = OK;
			SendTskMsg(SCH_IO_ID, TSK_INIT, RO_EVENT_CLR, NULL);
		}
	...
	if(aoException_Bak != aoException)
	{
		if(aoException)
		{
			...
			SendTskMsg(SCH_IO_ID, TSK_INIT, AO_OUTPUT, NULL);
		}
		else
		{
			AO_Event_Trig = OK;
