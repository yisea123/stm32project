...
typedef struct _T_DATACLASS
{
    ...
    uint16_t (*ResetToDefault)(const struct _T_DATACLASS *me);
    uint16_t (*SaveAsDefault)(const struct _T_DATACLASS *me);
} T_DATACLASS;
...
typedef struct _T_UNIT
{
    ...
    */
    //--------------------------------------------------------------------------------------------------
    uint16_t (*ResetToDefault)(const struct _T_UNIT *me, int16_t dataClassIndex);
    ...
    */
    //--------------------------------------------------------------------------------------------------
    uint16_t (*SaveAsDefault)(const struct _T_UNIT *me, int16_t dataClassIndex);
