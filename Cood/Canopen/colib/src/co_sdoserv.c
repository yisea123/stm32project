...
*-------------------------------------------------------------------
* $Id: co_sdoserv.c 20156 2017-10-30 13:08:11Z boe $
*
*
*-------------------------------------------------------------------
*
...
#else /* (defined(CO_EVENT_SDO_SERVER_DOMAIN_WRITE_CNT) || defined(CO_EVENT_STATIC_SDO_SERVER_DOMAIN_WRITE)) */
(void)pSdo;
#endif /* (defined(CO_EVENT_SDO_SERVER_DOMAIN_WRITE_CNT) || defined(CO_EVENT_STATIC_SDO_SERVER_DOMAIN_WRITE)) */
