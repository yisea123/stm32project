...
*-------------------------------------------------------------------
* $Id: co_sdoqueue.c 20166 2017-10-30 13:56:12Z boe $
*
*
*-------------------------------------------------------------------
* Changelog:
...
---------------------------------------------------------------------------*/
#ifndef CO_SDO_QUEUE_TIMEOUT
# define CO_SDO_QUEUE_TIMEOUT	1000ul
#endif /* ifndef CO_SDO_QUEUE_TIMEOUT */
...
static const UNSIGNED32	timeOut = { CO_SDO_QUEUE_TIMEOUT };
